---
title: 从 LangChain 到 LangGraph：Agent 框架基础真正要掌握什么
author: AI Agent 学习笔记
date: 2026-05-20
slug: langchain-to-langgraph-foundations
summary: 真正掌握 Agent 框架，不是记 API，而是理解能力组合和工作流编排。
description: 这篇文章从 LangChain 的 Runnable、LCEL、Tool、Retriever 讲起，再进入 LangGraph 的 State、Node、Edge、interrupt 和 checkpoint，用工程代码拆清楚 Agent 框架基础到底要掌握什么。
cover: ./diagram/langchain-langgraph-learning-map@2x.png
coverImage: ./diagram/langchain-langgraph-learning-map@2x.png
---
...
![从手写 Agent 到 Agentic RAG 的学习地图](./diagram/langchain-langgraph-learning-map@2x.png)
...
![RunnableParallel 并行分支](./diagram/wechat-mermaid/flow-01.png)
...
![LangGraph ReAct 状态图](./diagram/wechat-mermaid/flow-02.png)
...
## 六、`02_human_in_the_loop.py`：interrupt、thread\_id、checkpointer 如何支撑暂停恢复
...
![Human-in-the-loop 暂停恢复流程](./diagram/wechat-mermaid/flow-03.png)
...
![Plan-and-Execute 工作流](./diagram/wechat-mermaid/flow-04.png)
...
![什么时候用 Chain，什么时候用 Graph](./diagram/chain-vs-graph-decision@2x.png)
...
![Agentic RAG 为什么天然是 Graph](./diagram/agentic-rag-workflow@2x.png)
...
| 人机协作  | `02_human_in_the_loop.py`                       | 能说明 interrupt 为什么必须依赖 checkpointer 和 thread\_id |
