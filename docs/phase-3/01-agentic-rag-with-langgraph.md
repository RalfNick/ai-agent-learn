...
|------|-----|-----|-----|--------|--------------|----------|------|----------|
| `linear_hybrid_rerank` | 0.578 | 0.436 | 0.756 | 0.511 | 0.907 | 3269ms | $0.0296 | 60 |
| `agentic_rag_langgraph` | 0.572 | 0.425 | 0.756 | 0.503 | 0.980 | 5108ms | $0.0443 | 94 |
...
2. **Agentic RAG 的价值在质量控制**。Faithfulness 从 0.907 提升到 0.980，靠的是 check、repair、abstain 这些控制流。
3. **Agentic RAG 有成本**。平均延迟从 3269ms 增加到 5108ms，LLM 调用从 60 次增加到 94 次。
...
|------|-----|-----|--------|--------------|------|------|
| 线性 RAG | 0.578 | 0.436 | 0.511 | 0.907 | 3269ms | $0.0296 |
| Agentic RAG | 0.572 | 0.425 | 0.503 | 0.980 | 5108ms | $0.0443 |
...
Faithfulness 从 0.907 提升到 0.980，主要来自两个机制：
...
Agentic RAG 的 LLM 调用从 60 次增加到 94 次，成本从 $0.0296 增加到 $0.0443。
